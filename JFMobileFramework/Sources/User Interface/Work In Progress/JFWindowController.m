...
- (void)didLoadUserInterface
{
	if(self.logging)
	{
		NSString* message = [NSString stringWithFormat:@"Window '%@' user interface has been loaded.", PointerToString(self.window)];
...
- (void)loadUserInterface
{
	if(self.logging)
	{
		NSString* message = [NSString stringWithFormat:@"Window '%@' user interface is being loaded.", PointerToString(self.window)];
		[self.logger logMessage:message hashtags:LogHashtagComment];
	}
}
...
- (void)willLoadUserInterface
{
	if(self.logging)
	{
		NSString* message = [NSString stringWithFormat:@"Window '%@' user interface will be loaded.", PointerToString(self.window)];
		[self.logger logMessage:message hashtags:LogHashtagComment];
	}
}
...
- (void)windowDidBecomeHidden
{
	if(self.logging)
	{
		NSString* message = [NSString stringWithFormat:@"Window '%@' did become hidden.", PointerToString(self.window)];
		[self.logger logMessage:message hashtags:LogHashtagComment];
	}
}
...
- (void)windowDidBecomeKey
{
	if(self.logging)
	{
		NSString* message = [NSString stringWithFormat:@"Window '%@' did become key.", PointerToString(self.window)];
		[self.logger logMessage:message hashtags:LogHashtagComment];
	}
}
...
- (void)windowDidBecomeVisible
{
	if(self.logging)
	{
		NSString* message = [NSString stringWithFormat:@"Window '%@' did become visible.", PointerToString(self.window)];
		[self.logger logMessage:message hashtags:LogHashtagComment];
	}
...
- (void)windowDidResignKey
{
	if(self.logging)
	{
		NSString* message = [NSString stringWithFormat:@"Window '%@' did resign key.", PointerToString(self.window)];
		[self.logger logMessage:message hashtags:LogHashtagComment];
	}
}
