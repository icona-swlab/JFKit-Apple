...
- (void)notifiedThatKeyboardWillShow:(NSNotification*)notification
{
	...
	if(self.resizableView && self.resizableViewBottomConstraint)
	{
		...
		CGFloat height = ((!iOS8Plus && UIInterfaceOrientationIsLandscape(CurrentStatusBarOrientation)) ? CGRectGetWidth(info.endingFrame) : CGRectGetHeight(info.endingFrame));
